...
>(({ className, glowing, ...props }, ref) => (
  <div
    ref={ref}
    className={cn(
      'rounded-xl border border-zinc-800/80 bg-zinc-900/70 text-zinc-100 shadow-md backdrop-blur-md transition-all duration-200',
      glowing && 'border-emerald-500/30 shadow-emerald-950/20 shadow-lg',
      className
    )}
    {...props}
  />
